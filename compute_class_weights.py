...
if __name__ == '__main__':
    ...
    parser.add_argument('--coco_prefix', type=str, default='20231214233723', required=False,
                        help='Prefix of the COCO file. Default "exp1_patches2000_strat".')
    parser.add_argument('--medians_prefix', type=str, default='20231214233723_61x61', required=False,
