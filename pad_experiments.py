...
#python3 pad_experiments.py --train --model convlstm --parcel_loss 0 --weighted_loss --root_path_coco coco_files/ --prefix_coco 20231216232950 --netcdf_path dataset/netcdf/ --num_epochs 100 --batch_size 32 --bands B02 B03 B04 B08 --saved_medians --img_size 366 366 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window

# Below is for convlstm : working
#python3 pad_experiments.py --train --model convlstm --weighted_loss --root_path_coco coco_files/ --prefix_coco 20240220190606 --netcdf_path dataset/netcdf/ --num_epochs 100 --batch_size 8 --bands B02 B03 B04 B08 --saved_medians --img_size 366 366 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window

# Below is for unet : working
# python3 pad_experiments.py --train --model unet --weighted_loss --root_path_coco coco_files/ --prefix_coco 20231218125941 --netcdf_path dataset/netcdf/ --num_epochs 10 --batch_size 4 --bands B02 B03 B04 B08 --saved_medians --img_size 366 366 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window

# Below is for tempcnn : didn't work
# python3 pad_experiments.py --train --model tempcnn --weighted_loss --root_path_coco coco_files/ --prefix_coco 20231218125941 --netcdf_path dataset/netcdf/ --num_epochs 10 --batch_size 4 --bands B02 B03 B04 B08 --saved_medians --img_size 366 366 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window


# Below is for convstar : didn't work
# python3 pad_experiments.py --train --model convstar --weighted_loss --root_path_coco coco_files/ --prefix_coco 20231218125941 --netcdf_path dataset/netcdf/ --num_epochs 10 --batch_size 4 --bands B02 B03 B04 B08 --saved_medians --img_size 366 366 --requires_norm --num_workers 16 --num_gpus 1 --fixed_window
...
def main():
    ...
    parser.add_argument('--fixed_window', action='store_true', default=4, required=False,
    ...
    if args.train:
        ...
        #print("len(tensor1)", len(tensor1))
        #print("tensor1['medians'].shape", tensor1['medians'].shape)
        #print("tensor1['labels'].shape", tensor1['labels'].shape)
